...
const float MAX_RADIUS = 0.026;            // Max radius in normalized coords — tight ripple
...
vec4 COLOR = vec4(0.35, 0.36, 0.44, 0.8); // subtle grey ripple
const float BLUR = 3.5;                    // Blur level in pixels
const float ANIMATION_START_OFFSET = 0.01;       // Start slightly progressed
